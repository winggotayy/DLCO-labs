...
HD_PWD='F:/lab04_clock/lab04_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab04_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab04_clock.tcl
