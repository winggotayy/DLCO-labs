...
HD_PWD='F:/lab05/lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab05_registerfile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab05_registerfile.tcl
