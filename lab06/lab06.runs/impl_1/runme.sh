...
HD_PWD='F:/lab06/lab06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab06_random.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab06_random.tcl -notrace
