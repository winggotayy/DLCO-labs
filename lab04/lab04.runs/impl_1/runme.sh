...
HD_PWD='F:/lab04/lab04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab04_timer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab04_timer.tcl -notrace
